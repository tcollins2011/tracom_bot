  ...
  methods: {
    updateDynamicRanges() {
      const modelRanges = {
        ...
        'o1-mini': { temperature: [0, 2], maxTokens: [1, 512], topP: [0, 1], frequencyPenalty: [0, 2], presencePenalty: [0, 2] },
        'o1-preview': { temperature: [0, 2], maxTokens: [1, 1024], topP: [0, 1], frequencyPenalty: [0, 2], presencePenalty: [0, 2] },
      };
